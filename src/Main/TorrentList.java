...
//              }""";
    ...
    private ArrayList<String> oldProcessing(TorrentInfo torrentInfo) {
    ...
    public ArrayList<String> reloadUnits(Unit convertTo) {
    ...
    public ArrayList<String> getInfoToAdd(TorrentInfo torrentInfo, Unit sizeUnit) {
        ...
        switch(torrentInfo) {
            case NAME -> names.addAll(processJsonData(TorrentInfo.NAME));
            case PROGRESS -> progress = processJsonData(TorrentInfo.PROGRESS);
            case SIZE -> sizes.addAll(processJsonData(TorrentInfo.SIZE));
            case HASH -> hashes = processJsonData(TorrentInfo.HASH);
...
//        ArrayList<String> hashes = processJsonData(TorrentInfo.HASH);
        ...
        for(int i = 0; i < sizes.size(); i++) { //very unsafe may throw an outofbounds exception //TODO: fix this
